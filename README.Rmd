...
The goal of filter-slides-demo is to demonstrate how slides can be conditionally 
excluded with help of a lua-filter.  
...
If you want to exclude the ones with the given class `.advanced {}` you can add the 
lua-filter as a pandoc argument, like this: 
